            ...
            <Formik enableReinitialize 
                ...
                {({handleSubmit, isValid, isSubmitting, dirty}) => (
                    <Form className='ui form' onSubmit={handleSubmit} autoComplete='off'>
                        ...
                        <CustomSelect placeholder='Category' name='category' options={categoryOptions} />
                        <CustomDatePicker placeholderText='Date' name='date' showTimeSelect timeCaption='time' dateFormat='MMMM d, yyyy h:mm aa' />
