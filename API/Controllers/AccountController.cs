...
namespace API.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        {
            var user = await _userMgr.FindByEmailAsync(loginDto.Email); //returns user object OR null
        ...
        {
            var user = await _userMgr.FindByEmailAsync(User.FindFirstValue(ClaimTypes.Email));
